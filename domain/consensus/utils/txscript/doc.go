/*
Package txscript implements the nexepa transaction script language.

This package provides data structures and functions to parse and execute
nexepa transaction scripts.

# Script Overview

nexepa transaction scripts are written in a stack-base, FORTH-like language.

The nexepa script language consists of a number of opcodes which fall into
...
Typical nexepa scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend nexepa.
