...
// SignatureScript creates an input signature script for tx to spend nexe sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend nexe sent
