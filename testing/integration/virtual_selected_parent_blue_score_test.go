...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := nexepad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = nexepad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = nexepad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
