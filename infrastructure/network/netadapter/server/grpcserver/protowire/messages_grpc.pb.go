...
type P2P_MessageStreamClient interface {
	Send(*NexepadMessage) error
	Recv() (*NexepadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *NexepadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*NexepadMessage, error) {
	m := new(NexepadMessage)
...
func (x *p2PMessageStreamServer) Send(m *NexepadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*NexepadMessage, error) {
	m := new(NexepadMessage)
...
func (x *rPCMessageStreamClient) Send(m *NexepadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*NexepadMessage, error) {
	m := new(NexepadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *NexepadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*NexepadMessage, error) {
	m := new(NexepadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
