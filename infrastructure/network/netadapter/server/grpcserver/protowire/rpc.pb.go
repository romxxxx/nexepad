...
type GetBlockTemplateRequestMessage struct {
	...
	// Which nexepa address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether nexepad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when nexepad is not synced.
	// That is because when nexepad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this nexepad initiated the connection
	...
	// The timestamp of when this peer connected to this nexepad
