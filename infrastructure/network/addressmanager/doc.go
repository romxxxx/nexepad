/*
Package addressmanager implements concurrency safe nexepa address manager.

# Address Manager Overview

In order maintain the peer-to-peer nexepa network, there needs to be a source
of addresses to connect to as nodes come and go. The nexepa protocol provides
