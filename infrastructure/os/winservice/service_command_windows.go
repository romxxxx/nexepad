...
// installService attempts to install the nexepad service. Typically this should
...
// removeService attempts to uninstall the nexepad service. Typically this should
...
// startService attempts to Start the nexepad service.
