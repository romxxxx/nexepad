/*
Package util provides nexepa-specific convenience functions and types.

# Block Overview

A Block defines a nexepa block that provides easier and more efficient
...
A Tx defines a nexepa transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a nexepa address. While the
most common type is a pay-to-pubkey, nexepa already supports others and
