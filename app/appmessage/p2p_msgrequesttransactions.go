...
// MsgRequestTransactions implements the Message interface and represents a nexepa
...
// NewMsgRequestTransactions returns a new nexepa RequestTransactions message that conforms to
