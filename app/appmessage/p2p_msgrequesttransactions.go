...
// MsgRequestTransactions implements the Message interface and represents a Nexellia
...
// NewMsgRequestTransactions returns a new Nexellia RequestTransactions message that conforms to
