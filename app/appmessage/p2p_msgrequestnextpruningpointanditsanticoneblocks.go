...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a Nexellia
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new Nexellia RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
