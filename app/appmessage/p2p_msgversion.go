...
var DefaultUserAgent = fmt.Sprintf("/nexepad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a Nexellia version
...
// NewMsgVersion returns a new Nexellia version message that conforms to the
