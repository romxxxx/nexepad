...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a Nexellia
...
// NewMsgDoneBlocksWithTrustedData returns a new Nexellia DoneBlocksWithTrustedData message that conforms to the
// Message interface.
