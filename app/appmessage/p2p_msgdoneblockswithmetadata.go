...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a nexepa
...
// NewMsgDoneBlocksWithTrustedData returns a new nexepa DoneBlocksWithTrustedData message that conforms to the
// Message interface.
