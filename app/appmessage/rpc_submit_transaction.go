...
// RPCTransaction is a nexepad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a nexepad transaction input representation
...
// RPCScriptPublicKey is a nexepad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a nexepad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a nexepad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a nexepad utxo entry representation meant to be used
// over RPC
