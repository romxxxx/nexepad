...
// MsgRequestRelayBlocks implements the Message interface and represents a nexepa
...
// NewMsgRequestRelayBlocks returns a new nexepa RequestRelayBlocks message that conforms to
