...
// MsgRequestRelayBlocks implements the Message interface and represents a Nexellia
...
// NewMsgRequestRelayBlocks returns a new Nexellia RequestRelayBlocks message that conforms to
