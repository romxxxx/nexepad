...
// MsgRequestAddresses implements the Message interface and represents a Nexellia
...
// NewMsgRequestAddresses returns a new Nexellia RequestAddresses message that conforms to the
