...
// MsgRequestNextHeaders implements the Message interface and represents a Nexellia
...
// NewMsgRequestNextHeaders returns a new Nexellia RequestNextHeaders message that conforms to the
// Message interface.
