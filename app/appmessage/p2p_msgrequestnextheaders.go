...
// MsgRequestNextHeaders implements the Message interface and represents a nexepa
...
// NewMsgRequestNextHeaders returns a new nexepa RequestNextHeaders message that conforms to the
// Message interface.
