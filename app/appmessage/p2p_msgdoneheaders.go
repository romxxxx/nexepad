...
// MsgDoneHeaders implements the Message interface and represents a Nexellia
...
// NewMsgDoneHeaders returns a new Nexellia DoneIBDBlocks message that conforms to the
// Message interface.
