...
// MsgDoneHeaders implements the Message interface and represents a nexepa
...
// NewMsgDoneHeaders returns a new nexepa DoneIBDBlocks message that conforms to the
// Message interface.
