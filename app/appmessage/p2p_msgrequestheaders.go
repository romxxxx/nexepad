...
// MsgRequestHeaders implements the Message interface and represents a nexepa
...
// NewMsgRequstHeaders returns a new nexepa RequestHeaders message that conforms to the
