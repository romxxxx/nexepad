...
// MsgRequestHeaders implements the Message interface and represents a Nexellia
...
// NewMsgRequstHeaders returns a new Nexellia RequestHeaders message that conforms to the
