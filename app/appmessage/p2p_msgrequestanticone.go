...
// MsgRequestAnticone implements the Message interface and represents a Nexellia
...
// NewMsgRequestAnticone returns a new Nexellia RequestPastDiff message that conforms to the
