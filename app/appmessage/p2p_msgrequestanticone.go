...
// MsgRequestAnticone implements the Message interface and represents a nexepa
...
// NewMsgRequestAnticone returns a new nexepa RequestPastDiff message that conforms to the
