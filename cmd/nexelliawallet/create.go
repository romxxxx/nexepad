...
import (
	...
	"github.com/romxxxx/nexepad/cmd/nexelliawallet/libnexelliawallet/bip32"
...
func create(conf *createConfig) error {
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libnexelliawallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
