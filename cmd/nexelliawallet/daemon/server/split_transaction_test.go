...
import (
	...
	"github.com/romxxxx/nexepad/cmd/nexelliawallet/keys"
...
func TestEstimateMassAfterSignatures(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		signedTxStep1Bytes, err := libnexelliawallet.Sign(params, mnemonics[:1], unsignedTransactionBytes, false)
		if err != nil {
			t.Fatalf("Sign: %+v", err)
		}

		signedTxStep2Bytes, err := libnexelliawallet.Sign(params, mnemonics[1:2], signedTxStep1Bytes, false)
		if err != nil {
			t.Fatalf("Sign: %+v", err)
		}

		extractedSignedTx, err := libnexelliawallet.ExtractTransaction(signedTxStep2Bytes, false)
		if err != nil {
